...
3. **个人数据查询**：
   ...
   - `/psn游戏 <游戏名关键词>`：**指定某一款游戏**的详情——总游玩时长/小时、启动次数、首次与最近游玩日期，以及该游戏的奖杯完成度与白金/金/银/铜进度（支持模糊匹配，如 `/psn游戏 艾尔登法环`）。
4. **群内排行榜**：`/psn排行` 支持按
   - **游戏时长（肝度）**
   - **游戏数量**
   - **奖杯总分**（白金/金/银/铜加权）
...
>
> `/psn游戏` 示例：`/psn游戏 艾尔登法环`（查自己）、`/psn游戏 黑神话悟空 @某人`（查群友）。游戏名支持模糊匹配，展示该游戏的总时长、启动次数、首次/最近游玩日期与奖杯进度。
...
- 「@某人 现在在玩什么游戏？」
- 「看看我的奖杯」/「我的游戏库有哪些？」
- 「**艾尔登法环我玩了多久？**」/「**黑神话悟空的游戏信息**」/「这个游戏奖杯进度」
